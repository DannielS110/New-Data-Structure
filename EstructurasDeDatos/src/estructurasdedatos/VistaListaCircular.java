...
public class VistaListaCircular extends javax.swing.JPanel {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (!datosEntrada.isEmpty()) {
            ...
            listaCircular = new ListaCircular(); // Reiniciar la lista circular
            ...
            listaCircular.validarListaCircular(); // Validar la circularidad antes de ordenar
            listaCircular.ordenar();
            listaCircular.validarListaCircular(); // Validar la circularidad después de ordenar
    ...
    private void actualizarAreaMostrarDatos() {
        ...
        NodoListas temp = listaCircular.cabeza;
        int contador = 0;
        if (temp != null) {
            do {
                ...
                contador++;
            } while (temp != listaCircular.cabeza && contador <= listaCircular.getSize());
        }
        sb.append("\nLa lista es circular: el ultimo nodo apunta de vuelta al primero.\n");
