...
public class VistaListaDoblementeEnlazada extends javax.swing.JPanel {
    ...
    public VistaListaDoblementeEnlazada() {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        if (!datosEntrada.isEmpty()) {
            ...
            listaDoblementeEnlazada = new ListaDoblementeEnlazada(); // Reiniciar la lista doblemente enlazada
            for (String valor : valores) {
                try {
                    int numero = Integer.parseInt(valor);
                    listaDoblementeEnlazada.insertar(numero);
                } catch (NumberFormatException e) {
                    JOptionPane.showMessageDialog(this, "Ingrese solo números enteros.");
                    return;
                }
            }
            actualizarAreaMostrarDatos();  // Mostrar la lista antes de ordenar
            listaDoblementeEnlazada.ordenar();
            actualizarAreaMostrarDatosOrdenada();
            actualizarAreaMostrarDatosReversa();
        }
    ...
    private void btnRegresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegresarActionPerformed
     ...
     private void actualizarAreaMostrarDatos() {
        ...
        sb.append("Recorrido de la lista antes de ordenar:\n");
        NodoListas temp = listaDoblementeEnlazada.cabeza;
        while (temp != null) {
    ...
    private void actualizarAreaMostrarDatosOrdenada() {
        StringBuilder sb = new StringBuilder(txtAreaMostrarDatos.getText());
        sb.append("Recorrido de la lista despues de ordenar:\n");
        NodoListas temp = listaDoblementeEnlazada.cabeza;
        while (temp != null) {
            sb.append(temp.valor).append(" ");
            temp = temp.nodoSiguiente;
    ...
    private void actualizarAreaMostrarDatosReversa() {
        StringBuilder sb = new StringBuilder(txtAreaMostrarDatos.getText());
        sb.append("Recorrido en reversa de la lista:\n");
        NodoListas temp = listaDoblementeEnlazada.cola;
        while (temp != null) {
            sb.append(temp.valor).append(" ");
